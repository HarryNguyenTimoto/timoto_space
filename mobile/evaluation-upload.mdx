...
description: "Live RN uses POST /bikes/:id/evaluate/async/ 202. Legacy POST /evaluation/bike/ AllowAny sync with raw SQL media requires pictures or audio. Authenticated listing confirm sets marketplace_status liste"
---
