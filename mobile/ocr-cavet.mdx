...
description: "Live ScanBikeCer uses runCavetOcr on-device Vision/ML Kit then Paddle ONNX. ENABLE_ONDEVICE_CAVET_OCR true. ENABLE_GEMINI_OCR_FALLBACK false by default. Backend POST /api/v1/ocr/vehicle-registration/ "
---
