...
description: "Live mobileSignup sends no password; backend PendingUser uses TempPassword123!. mobile_login sends SNS SMS ap-southeast-1. Verify requires DEV_OTP_PASSWORD and admin_set_user_password before Cognito t"
---
