...
description: "RN POSTs /operator-review-requests/ then WS with IdToken query. valuation_ready then authenticated GET /evaluation/result/. Timeout 120s. assign-owner SELECT FOR UPDATE. Cancel enforces exactly one of"
---
