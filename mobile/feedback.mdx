...
description: "GET and POST share /api/v1/feedback/. IsAuthenticated. UniqueConstraint feedback_unique_per_user. Second POST 400 Feedback already submitted. Rating 1 to 5 required. Django admin UserAppFeedbackAdmin "
---
