...
description: "Line-level facts from chotot.py, lambda_handler.py, refresh_handler.py, export_quality_bikes.py: CATEGORY 2020, LIMIT 50, WORKERS 20 vs 25, TIME_BUDGET_SEC 780, DynamoDB chotot-xe-may, 24-field flatte"
---
