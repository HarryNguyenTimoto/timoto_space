...
- Async bikes: media.count equals 0 fails — **video-only OK**
- Sync evaluation/bike: needs picture\_urls **or** audio\_urls — **video-only fails** error\_code 3

Sync hint text uses Use /api/v1/bikes/:bike\_id/media/... (does not say POST). Async no\_media body uses POST hint.
...
Key: prefix / bike\_uuid / bike\_uuid _image_ index .jpg. If Bike DoesNotExist, index starts at 1. Expires 3600s.
