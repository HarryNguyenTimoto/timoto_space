...
description: "TiMoto-AI-Web infrastructure/waitlist handler.mjs: API Gateway POST OPTIONS CORS, normalize VN phone and email, Query phone-index or email-index, PutItem source landing_android_waitlist. No frontend caller wired in-repo."
---
