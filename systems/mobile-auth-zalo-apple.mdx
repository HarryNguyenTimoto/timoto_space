...
description: "Live paths POST /auth/zalo/start/, GET /auth/zalo/callback/, POST /auth/zalo/native/, POST /auth/apple/native/. PKCE state in users_zaloauthstate; Cognito ADMIN_NO_SRP_AUTH with HMAC passwords; Graph proxy for VN egress; Apple JWT via JWKS."
---
