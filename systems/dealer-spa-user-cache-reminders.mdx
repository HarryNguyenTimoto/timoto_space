...
description: "timoto_dealer_portal_v2 userService singleton caches GET /auth/me/ until logout. autoReminderService is client-side localStorage timers (winning 5s, deposit 30 min and 10 min, payment 24h) that optionally re-GET auction detail. Not the notifications REST inbox."
---
