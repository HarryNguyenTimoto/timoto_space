...
description: "Mobile internal_operator_offer.py fetches dual-price snapshots from internal MobileOperatorOfferReadView; listing_views internal_buyer_found_callback HMAC-signs listing_id only and sets SellerListing status buyer_found."
---
...
| Method | Path | Auth |
| --- | --- | --- |
| POST | `/api/v1/internal/listings/:listing_id/buyer-found/` | HMAC; `AllowAny` |
