---
title: "TMA Mobile Auth: SNS OTP, DEV_OTP_PASSWORD, CONFIRMATION_CODE"
sidebarTitle: "Mobile Auth SNS OTP"
description: "Live mobileSignup sends no password; backend PendingUser uses TempPassword123!. mobile_login sends SNS SMS ap-southeast-1. Verify requires DEV_OTP_PASSWORD and admin_set_user_password before Cognito tokens. CONFIRMATION_CODE defaults to 654321. already_registered returns session without SMS. No logout route."
---
