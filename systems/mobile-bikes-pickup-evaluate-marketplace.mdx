...
description: "timoto-mobile /api/v1 bikes: raw SQL pickup, pg_notify pickup_scheduled with key type only, evaluate async 202 plus EVALUATION_PENDING poll, marketplace gas eligibility SUBMITTED pricing only. can_reschedule after cancel when valuation valid. No pickup_cancelled NOTIFY. No INSTANT_PURCHASE_MAX_DAYS_AHEAD constant."
---
