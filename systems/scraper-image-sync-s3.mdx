...
description: "image_sync_producer.py enqueues media jobs from chotot-xe-may date-index or full scan into SQS. image_sync_worker.py downloads URLs, uploads to chotot-dashboard bucket, tracks chotot-image-sync-state. Continuations via async self-invoke. monitor_image_sync.py polls queue and DLQ."
---
