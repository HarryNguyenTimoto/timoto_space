...
description: "timoto-dealer-portal catalog ViewSet, Cognito JWT vs X-Timoto-Service-Key S2S, shared Checkout SELECT FOR UPDATE, VietQR order_id recipes, paid_hook_url allowlist, and combo reservation only after paid — not at order create."
---
