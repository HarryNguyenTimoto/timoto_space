...
description: "analytics.track identify screen are no-ops even when ENABLE_ANALYTICS and consent. Consent AsyncStorage key is @analytics/consent_granted. AnalyticsBinder mounts in AppNavigator; setupAirbridge in apps/index.js. PostHog still captures app_opened and screen via navigationRef. Airbridge logs URL only in __DEV__."
---
