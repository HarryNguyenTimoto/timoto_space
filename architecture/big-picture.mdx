...
For the operational incident-repair control plane, read [AI Repair Foundation](/architecture/timoto-ai-repair-foundation). It documents the seven-folder `AI_infra_timoto` workspace, its six registered runtime targets, trust boundaries, local verification, and remaining live gates.
