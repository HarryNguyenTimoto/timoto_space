...
description: "GET /api/auth/zalo/login/ sets signed zalo_pkce cookie, redirects to Zalo permission. Callback exchanges code via VN proxy or direct secret_key, creates Cognito user with ZALO_COGNITO_PASSWORD, HTML-r"
---
