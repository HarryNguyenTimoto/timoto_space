...
description: "timoto-dealer-portal users/views.py: check-user, signup PendingUser, confirm-signup and login Step 2 both accept only 654321, no SMS. Login GET puts secrets in the query string. Cognito password store"
---
