...
description: "DealerOrderViewSet user-scoped. Combo select_for_update on create item insert does not decrement quantity. Serializer can_cancel is true whenever delivering, including paid; cancel action then 400. In"
---
