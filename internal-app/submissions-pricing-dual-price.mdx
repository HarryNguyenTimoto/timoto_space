...
description: "timoto-internal-app submissions_api.py plus tipp_pricing.py: OPS enters FMP as offer_to_user, server snapshots listing_price_vnd and instant_price_vnd only on submit, HMAC mobile operator-offer read, "
---
