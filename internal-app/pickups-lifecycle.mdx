...
description: "timoto-internal-app pickups_api.py: waiting schedules scheduled or confirmed with SUBMITTED pricing, PATCH schedule fields, inspection draft, POST picked-up via USER_DB_WRITE, reject reason min 5 char"
---
